        ...
        <form className={cn("flex flex-col gap-6", className)} onSubmit={handleSubmit} {...props}>
            <FieldGroup>
                ...
                <Field className="grid grid-cols-3 gap-4">
                    <Button variant="outline" type="button" onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/apple"}>
                    ...
                    <Button variant="outline" type="button" onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/google"}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                            <path
                    ...
                    <Button variant="outline" type="button" onClick={() => window.location.href = "http://localhost:8080/oauth2/authorization/facebook"}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                            <path
